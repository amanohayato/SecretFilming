...
class Citizen_Signal1 : public BuildingBase {
public:
	Citizen_Signal1(IWorld* world, const Vector3& position, int rotationNum = 0);
	Citizen_Signal1(IWorld* world, const Vector2& position, int rotationNum = 0);
	Citizen_Signal1(IWorld* world, int width, int height, int rotationNum = 0, const Vector2& offset = Vector2::Zero);
